...
public class Connection {
    ...
    private final SystemNode system2;
     ...
     */
    public Connection(SystemNode system1, SystemNode system2, Integer weight) {
     ...
     */
    public SystemNode getOtherSystem(SystemNode system) {
