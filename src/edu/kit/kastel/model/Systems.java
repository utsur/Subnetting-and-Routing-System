 ...
 * There are computers and routers which have different functions that are specified in their according classes.
 * @author utsur
 */
public class Systems {
     ...
     */
    public Systems(String name, String ipAddress, Subnet subnet) {
        this.name = name;
